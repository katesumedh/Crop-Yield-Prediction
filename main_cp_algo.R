...
#Linear model
l1<-lm(f1$Production ~ f1$District_Name+f1$Crop+f1$Area+f1$pH_min+f1$pH_max+f1$pH_Req+f1$min_temp+f1$max_temp,data=train_data)
s1<-summary(l1)
print(s1)
...
pred3<-predict(xgb_tune,test_new)
